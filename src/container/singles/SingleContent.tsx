...
const SingleContent: FC<SingleContentProps> = ({ post }) => {
  ...
  // Process the content to insert ads
  const contentElements = insertAdsIntoContent(content || '')
  ...
  const renderAlert = () => {
    ...
    return (
      <Alert type="warning">
        This post is {status}. It will not be visible on the website until it is
        published.
      </Alert>
    )
  }
  ...
  return (
    <div className="relative flex flex-col">
      <div className="nc-SingleContent flex-1 space-y-10">
        ...
        {/* COMMENTS LIST - Do not delete comments id */}
        {commentStatus === 'open' ? (
          <div
            id="comments"
