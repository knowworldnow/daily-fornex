...
const Page: FaustPage<PostsFilterPageQueryGetPostsQuery> = (props) => {
  ...
  return (
    <>
      <SEO 
        title="Explore Posts - Daily Fornex"
        description="Explore the latest posts on Daily Fornex, covering various topics to keep you informed."
        url={`https://dailyfornex.com${router.asPath}/`}
      />
      <PageLayout
